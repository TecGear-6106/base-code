...
public final WPI_TalonSRX rightmotor1 = new WPI_TalonSRX(1);
public final WPI_TalonSRX rightmotor2 = new WPI_TalonSRX(2);
public final WPI_TalonSRX leftmotor1 = new WPI_TalonSRX(3);
public final WPI_TalonSRX leftmotor2 = new WPI_TalonSRX(4);
...
DifferentialDrive drivetrain = new DifferentialDrive(leftSpeedGroup, rightSpeedGroup);
  ...
  public void teleopPeriodic() {
    drivetrain.arcadeDrive(Control1.getRightX()*(-1), Control1.getLeftY()*(-0.8));
  }
